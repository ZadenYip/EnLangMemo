...
面向 Refold 的 2A - 2B 阶段，通过观看感兴趣的视频，然后鼠标划词字幕弹出词典制闪卡，接着利用 [FSRS](https://github.com/open-spaced-repetition) 间隔重复算法对卡片进行排程定期复习。

本项目为个人兴趣而开发，~~没有后续维护的保证,随时准备跑路。~~ 后续维护看心情以及工作后是否忙碌。

基本上，这个项目是落地自己想法和解决自己痛点才做的，不过也欢迎 fork 和 PR。
