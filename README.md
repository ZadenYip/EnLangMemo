...
受 [Refold 学习外语](https://zhuanlan.zhihu.com/p/671671625) 启发开发的本地优先英语学习软件。
面向 Refold 的 2A - 2B 阶段，通过观看感兴趣的视频，然后鼠标划词字幕弹出词典制闪卡，接着利用 [FSRS](https://github.com/open-spaced-repetition) 间隔重复算法对卡片进行排程定期复习，后续考虑加入阅读文字材料的功能。

本项目为个人兴趣和自用开发的，~~没有后续维护的保证,随时准备跑路。~~ 后续维护看精力。

目前项目的客户端部分基本上主流程完成了，还要需要添加每日自带重置学习上限，以及编辑笔记模板等功能。
...
- [ ] SRT 解析器性能优化
- [ ] 同步服务器开发（核心流程完成了，同步功能能正常使用了，性能还需调优）
- [ ] 去除 SQLite 的自带的 rowid 
- [ ] FSRS 牌组算法参数的训练和配置对接
- [ ] 已成型卡片的删除、编辑功能
- [ ] 可自创建预设外的笔记模板
- [ ] 支持媒体文件
